...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if ($ecrivainModel->ajouter($nom, $prenom, $nationalite, $date_naissance)) {
            header('Location: index.php?message=Écrivain ajouté avec succès&type=success');
            exit;
        } else {
            throw new Exception("Erreur lors de l'ajout de l'écrivain");
        }
    } catch (Exception $e) {
...
<head>
    ...
    <title>Ajouter un Écrivain - Bibliothèque</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <header>
        <div class="container">
            <h1 style="text-align: center; margin-bottom: 20px;">➕ Ajouter un Écrivain</h1>
            <nav>
                <ul>
    ...
    <div class="container">
        ...
        <div class="card">
            <h2>Informations de l'écrivain</h2>
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nationalite" name="nationalite" required 
                           ...
                           value="<?= isset($_POST['nationalite']) ? htmlspecialchars($_POST['nationalite']) : '' ?>">
                </div>
